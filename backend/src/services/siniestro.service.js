...
async function createSiniestro(siniestro) {
  ...
  try {
    ...
    const { sin_velocidadViento, sin_temperatura, sin_humedad, sin_fechaInicio, sin_fechaTermino, sin_latitud, sin_superficie, sin_distribucion_fuego, sin_incidente} = siniestro;
